...
with open(f'{drive_letter}:\{drive_letter}_drive-sccm-check-for-software.bat', "w") as file:
    file.write(f'powershell.exe -executionpolicy bypass -File "{drive_letter}:\\Scripts\\sccm-check-for-software.ps1"') 
